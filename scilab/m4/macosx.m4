...
AC_DEFUN([AC_GET_MACOSX_VERSION],[
    ...
    case $macosx_version in
         14.*)
              AC_MSG_RESULT([macOS $macosx_version - Sonoma.])
         ;;
         13.*)
              AC_MSG_RESULT([macOS $macosx_version - Ventura.])         
         ;;
         12.*)
              AC_MSG_RESULT([macOS $macosx_version - Monterey.])
         ;;
         11.*)
         ...
         ;;
         *)
              AC_MSG_ERROR([macOS 10.13 to 13 are needed. Found $macosx_version])
         ;;
    esac
])
