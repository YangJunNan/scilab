...
#define SUNDIALS_BUILD_PACKAGE_FUSED_KERNELS 1

/* BUILD SUNDIALS with monitoring functionalities */
#define SUNDIALS_BUILD_WITH_MONITORING 1
...
#define SUNDIALS_SUNLINSOL_SPTFQMR 0
