...
int sunBrussE(realtype t, N_Vector y, N_Vector ydot, void *user_data);
int sunBrussI(realtype t, N_Vector y, N_Vector ydot, void *user_data);
...
int main(int argc, char *argv[])
{
  ...
  /* Call ARKStepCreate to initialize the ARK timestepper module and
     specify the right-hand side functions in y'=sunBrussE(t,y)+sunBrussI(t,y),
     the inital time T0, and the initial dependent variable vector y. */
  arkode_mem = ARKStepCreate(sunBrussE, sunBrussI, T0, y, ctx);
