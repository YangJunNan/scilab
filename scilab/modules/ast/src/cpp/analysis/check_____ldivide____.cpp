...
namespace analysis
{
TIType Checkers::check_____ldivide____(GVN & gvn, const TIType & in0, const TIType & in1)
{
    switch (in0.type)
    {
        case TIType::EMPTY :
        ...
        case TIType::BOOLEAN :
        {
            switch (in1.type)
            {
                ...
                case TIType::BOOLEAN :
                {
                    ...
                    if (in1.rows == in0.rows)
                    {
                        return TIType(gvn, TIType::DOUBLE, in0.cols, in1.cols);
                    }
                ...
                case TIType::COMPLEX :
                {
                    ...
                    if (in1.rows == in0.rows)
                    {
                        return TIType(gvn, TIType::COMPLEX, in0.cols, in1.cols);
                    }
                ...
                case TIType::INT16 :
                {
                    ...
                    if (in1.rows == in0.rows)
                    {
                        return TIType(gvn, TIType::INT16, in0.cols, in1.cols);
                    }
                ...
                case TIType::INT32 :
                {
                    ...
                    if (in1.rows == in0.rows)
                    {
                        return TIType(gvn, TIType::INT32, in0.cols, in1.cols);
                    }
                ...
                case TIType::INT64 :
                {
                    ...
                    if (in1.rows == in0.rows)
                    {
                        return TIType(gvn, TIType::INT64, in0.cols, in1.cols);
                    }
                ...
                case TIType::INT8 :
                {
                    ...
                    if (in1.rows == in0.rows)
                    {
                        return TIType(gvn, TIType::INT8, in0.cols, in1.cols);
                    }
                ...
                case TIType::UINT16 :
                {
                    ...
                    if (in1.rows == in0.rows)
                    {
                        return TIType(gvn, TIType::UINT16, in0.cols, in1.cols);
                    }
                ...
                case TIType::UINT32 :
                {
                    ...
                    if (in1.rows == in0.rows)
                    {
                        return TIType(gvn, TIType::UINT32, in0.cols, in1.cols);
                    }
                ...
                case TIType::UINT64 :
                {
                    ...
                    if (in1.rows == in0.rows)
                    {
                        return TIType(gvn, TIType::UINT64, in0.cols, in1.cols);
                    }
                ...
                case TIType::UINT8 :
                {
                    ...
                    if (in1.rows == in0.rows)
                    {
                        return TIType(gvn, TIType::UINT8, in0.cols, in1.cols);
                    }
