...
void Triangulator::fillPoints(void)
{
    ...
    //This method does not preserve facet orientation and is thus abandonned
    //in favor of rotation approach below (see http://bugzilla.scilab.org/show_bug.cgi?id=16755)
    // if (xmin == xmax)
    // {
