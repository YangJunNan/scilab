...
SWIGEXPORT void JNICALL Java_org_scilab_modules_commons_ScilabCommonsJNI_setPolynomialDisplay(JNIEnv *jenv, jclass jcls, jint jarg1) {
  int arg1 ;
  
  (void)jenv;
  (void)jcls;
  arg1 = (int)jarg1; 
  setPolynomialDisplay(arg1);
}


SWIGEXPORT jint JNICALL Java_org_scilab_modules_commons_ScilabCommonsJNI_getPolynomialDisplay(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
  
  (void)jenv;
  (void)jcls;
  result = (int)getPolynomialDisplay();
  jresult = (jint)result; 
  return jresult;
}
