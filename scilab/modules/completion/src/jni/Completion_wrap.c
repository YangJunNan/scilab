...
SWIGEXPORT jobjectArray JNICALL Java_org_scilab_modules_completion_CompletionJNI_searchMustBeDictionary(JNIEnv *jenv, jclass jcls, jstring jarg1) {
  jobjectArray jresult = 0 ;
  char *arg1 = (char *) 0 ;
  char **result = 0 ;
  ...
  result = (char **)searchMustBeDictionary(arg1);
  {
    if (result != NULL)
    {
      int i;
