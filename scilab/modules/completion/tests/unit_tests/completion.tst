...
r = completion("ho");
assert_checkequal(r, ["home"; "horizontalalignment"; "horner"; "host"; "hotcolormap"; "hours"; "householder"]);
...
assert_checkequal(r, ["horner"; "hotcolormap"; "hours"; "householder"]);
...
assert_checkequal(macros, ["horner"; "hotcolormap"; "hours"; "householder"]);
