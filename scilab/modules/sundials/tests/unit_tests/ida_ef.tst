...
[t,y1,yp1,info1] = ida(list(diffuse_res,tr1,tr2,alpha),[0 tf],u0,M\(J*u0),jacBand=[1 1]);
[t,y2,yp2,info2] = ida(list(diffuse_res,tr1,tr2,alpha),[0 tf],u0,M\(J*u0),jacPattern=A);
