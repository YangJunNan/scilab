...
// EVENTS
[t,y,te,ye,ie] = arkode(list(vdp,mu), [0,10], y0,jacobian=list(vdpJac,mu),events=list(myevent,0,0));
assert_checkalmostequal(ye(1,:),[1.7,1.7 1.7]);
assert_checkalmostequal(te,[ 1.21746186   6.668978609   7.860696911],1e-4);
//
[t,y,te,ye,ie] = arkode(list(vdp,mu), [0,10], y0,jacobian=list(vdpJac,mu),events=list(myevent,0,-1));
assert_checkalmostequal(ye(1,:),[1.7, 1.7]);
assert_checkalmostequal(te,[ 1.21746186    7.860696911],1e-4);
//
[t,y,te,ye,ie] = arkode(list(vdp,mu), [0,10], y0,jacobian=list(vdpJac,mu),events=list(myevent,0,-1));
assert_checkalmostequal(ye(1,:),[1.7, 1.7]);
assert_checkalmostequal(te,[ 1.21746186    7.860696911],1e-4);
//
[t,y,te,ye,ie] = arkode(list(vdp,mu), [0,10], y0,jacobian=list(vdpJac,mu),events=list(myevent,1,1));
assert_checkequal(te, t($));
assert_checkalmostequal(ye(1,:),[1.7]);
assert_checkalmostequal(te,[6.668978609],1e-4);
//
[t,y,te,ye,ie] = arkode(list(vdp,mu), [0,10], y0,jacobian=list(vdpJac,mu),events=list(myevent,0,0));
...
te = 0;
while %t
    [t,y,tev,ye] = arkode(list(bounce,9.81), [te($) 100], yini, events=bounce_ev, refine=16);
    if tev==[]
        break;
    end
...
bet=0.2;
y0=[N-1;1;0];
[t,y,te,ye]=arkode(list(sir,bet,gam,N),[0 400],y0,events=sir_ev);
assert_checkalmostequal(te, 114.55992,1e-6);
assert_checkalmostequal(ye,[   7499999.999999705702066
